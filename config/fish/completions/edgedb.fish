...
complete -c edgedb -n "__fish_edgedb_using_subcommand configure; and not __fish_seen_subcommand_from insert reset set help" -s I -l instance -d 'Instance name (use gel instance list to list local, remote and Gel Cloud instances available to you)' -r -f
complete -c edgedb -n "__fish_edgedb_using_subcommand configure; and not __fish_seen_subcommand_from insert reset set help" -l dsn -d 'DSN for Gel to connect to (overrides all other options except password)' -r
...
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and not __fish_seen_subcommand_from create list status start stop restart destroy link unlink logs resize backup restore list-backups upgrade revert reset-password credentials help" -s I -l instance -d 'Name of the instance' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and not __fish_seen_subcommand_from create list status start stop restart destroy link unlink logs resize backup restore list-backups upgrade revert reset-password credentials help" -f -a "backup" -d 'Create a backup for an instance (Gel Cloud only)'
...
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and not __fish_seen_subcommand_from create list status start stop restart destroy link unlink logs resize backup restore list-backups upgrade revert reset-password credentials help" -f -a "list-backups" -d 'Restore an instance from a backup (Gel Cloud only)'
...
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and __fish_seen_subcommand_from create" -s I -l instance -d 'Name of the instance' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and __fish_seen_subcommand_from list" -s I -l instance -d 'Name of the instance' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and __fish_seen_subcommand_from status" -s I -l instance -d 'Name of the instance' -r -f
...
launchctl\t''
edgedb-cli\t''"
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and __fish_seen_subcommand_from start" -s I -l instance -d 'Name of the instance' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and __fish_seen_subcommand_from stop" -s I -l instance -d 'Name of the instance' -r -f
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and __fish_seen_subcommand_from stop" -s h -l help -d 'Print help'
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and __fish_seen_subcommand_from restart" -s I -l instance -d 'Name of the instance' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and __fish_seen_subcommand_from destroy" -s I -l instance -d 'Name of the instance' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and __fish_seen_subcommand_from unlink" -s I -l instance -d 'Name of the instance' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and __fish_seen_subcommand_from logs" -s I -l instance -d 'Name of the instance' -r -f
...
testing\t''
nightly\t''"
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and __fish_seen_subcommand_from upgrade" -s I -l instance -d 'Name of the instance' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and __fish_seen_subcommand_from revert" -s I -l instance -d 'Name of the instance' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and __fish_seen_subcommand_from reset-password" -s I -l instance -d 'Name of the instance' -r -f
...
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and __fish_seen_subcommand_from help" -f -a "backup" -d 'Create a backup for an instance (Gel Cloud only)'
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and __fish_seen_subcommand_from help" -f -a "restore" -d 'Restore an instance from a backup (Gel Cloud only)'
complete -c edgedb -n "__fish_edgedb_using_subcommand instance; and __fish_seen_subcommand_from help" -f -a "list-backups" -d 'Restore an instance from a backup (Gel Cloud only)'
...
complete -c edgedb -n "__fish_edgedb_using_subcommand extension; and not __fish_seen_subcommand_from list list-available install uninstall help" -s I -l instance -d 'Name of the instance' -r
...
complete -c edgedb -n "__fish_edgedb_using_subcommand extension; and __fish_seen_subcommand_from list" -s I -l instance -d 'Name of the instance' -r
...
complete -c edgedb -n "__fish_edgedb_using_subcommand extension; and __fish_seen_subcommand_from list-available" -s I -l instance -d 'Name of the instance' -r
...
complete -c edgedb -n "__fish_edgedb_using_subcommand extension; and __fish_seen_subcommand_from install" -s I -l instance -d 'Name of the instance' -r
...
complete -c edgedb -n "__fish_edgedb_using_subcommand extension; and __fish_seen_subcommand_from uninstall" -s I -l instance -d 'Name of the instance' -r
...
complete -c edgedb -n "__fish_edgedb_using_subcommand cli; and not __fish_seen_subcommand_from upgrade install migrate help" -f -a "upgrade" -d 'Upgrade the gel command-line tool'
complete -c edgedb -n "__fish_edgedb_using_subcommand cli; and not __fish_seen_subcommand_from upgrade install migrate help" -f -a "install" -d 'Install the gel command-line tool'
